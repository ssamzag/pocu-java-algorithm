...
public class Program {
    public static void main(String[] args) {
        ...
        registry.validate();
        {
            ...
            redStamp.setShippingMethod(ShipmentType.PICK_UP);

            assert redStamp.shippingMethod == ShipmentType.PICK_UP;
            ...
            whiteCalendar.setShippingMethod(ShipmentType.SHIP);

            assert cart.getProducts().get(1) == whiteCalendar : "같은 달력이니";
            assert whiteCalendar.shippingMethod == ShipmentType.SHIP;
