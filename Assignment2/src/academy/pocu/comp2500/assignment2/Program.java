...
public class Program {
    public static void main(String[] args) {
        ...
        registry.validate();
        {
            ...
            redStamp.setShipment(ShipmentType.PICK_UP);

            assert redStamp.shipment == ShipmentType.PICK_UP;
            ...
            whiteCalendar.setShipment(ShipmentType.SHIP);

            assert cart.getProducts().get(1) == whiteCalendar : "같은 달력이니";
            assert whiteCalendar.shipment == ShipmentType.SHIP;
